...
<ul class="navbar-nav sidebar sidebar-dark accordion toggled" id="accordionSidebar"
    ...
    <li class="nav-item {{ Request::is('/') ? 'active' : '' }}">
        <a class="nav-link" href="{{ url('/') }}">
            ...
            <span style="font-size: 12px">Dashboard SLA Klaim FKRTL</span>
        </a>
    </li>
    ...
    <li class="nav-item {{ Request::route()->getName() == 'absent-claim' ? 'active' : '' }}">
        <a class="nav-link" href="{{ url('/claim-absensi') }}">
            ...
            <span style="font-size: 10px">Dashboard Absensi Klaim FKRTL</span>
        </a>
    </li>

    <li class="nav-item {{ Request::route()->getName() == 'claim.fktp' ? 'active' : '' }}">
        <a class="nav-link" href="{{ url('/claim-fktp') }}">
            <svg xmlns="http://www.w3.org/2000/svg" height="22" width="24" viewBox="0 0 576 512">
                <path fill="#ffffff"
                    d="M64 64C28.7 64 0 92.7 0 128v64c0 8.8 7.4 15.7 15.7 18.6C34.5 217.1 48 235 48 256s-13.5 38.9-32.3 45.4C7.4 304.3 0 311.2 0 320v64c0 35.3 28.7 64 64 64H512c35.3 0 64-28.7 64-64V320c0-8.8-7.4-15.7-15.7-18.6C541.5 294.9 528 277 528 256s13.5-38.9 32.3-45.4c8.3-2.9 15.7-9.8 15.7-18.6V128c0-35.3-28.7-64-64-64H64zm64 112l0 160c0 8.8 7.2 16 16 16H432c8.8 0 16-7.2 16-16V176c0-8.8-7.2-16-16-16H144c-8.8 0-16 7.2-16 16zM96 160c0-17.7 14.3-32 32-32H448c17.7 0 32 14.3 32 32V352c0 17.7-14.3 32-32 32H128c-17.7 0-32-14.3-32-32V160z" />
            </svg>
            <span style="font-size: 12px">Dashboard SLA Klaim FKTP</span>
        </a>
    </li>

    <li class="nav-item {{ Request::route()->getName() == 'absent-claim.fktp' ? 'active' : '' }}">
        <a class="nav-link" href="{{ url('/claim-absensi-fktp') }}">
            <svg xmlns="http://www.w3.org/2000/svg" height="22" width="24" viewBox="0 0 512 512">
                <path fill="#ffffff"
                    d="M152.1 38.2c9.9 8.9 10.7 24 1.8 33.9l-72 80c-4.4 4.9-10.6 7.8-17.2 7.9s-12.9-2.4-17.6-7L7 113C-2.3 103.6-2.3 88.4 7 79s24.6-9.4 33.9 0l22.1 22.1 55.1-61.2c8.9-9.9 24-10.7 33.9-1.8zm0 160c9.9 8.9 10.7 24 1.8 33.9l-72 80c-4.4 4.9-10.6 7.8-17.2 7.9s-12.9-2.4-17.6-7L7 273c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l22.1 22.1 55.1-61.2c8.9-9.9 24-10.7 33.9-1.8zM224 96c0-17.7 14.3-32 32-32H480c17.7 0 32 14.3 32 32s-14.3 32-32 32H256c-17.7 0-32-14.3-32-32zm0 160c0-17.7 14.3-32 32-32H480c17.7 0 32 14.3 32 32s-14.3 32-32 32H256c-17.7 0-32-14.3-32-32zM160 416c0-17.7 14.3-32 32-32H480c17.7 0 32 14.3 32 32s-14.3 32-32 32H192c-17.7 0-32-14.3-32-32zM48 368a48 48 0 1 1 0 96 48 48 0 1 1 0-96z" />
            </svg>
            <span style="font-size: 10px">Dashboard Absensi Klaim FKTP</span>
        </a>
    </li>

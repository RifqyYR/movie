...
<ul class="navbar-nav sidebar sidebar-dark accordion toggled" id="accordionSidebar"
    ...
    @if (!in_array(Auth::user()->role, ['ARCHIVE', 'SDMUK']))
        <li
    ...
    <li
        ...
        <a class="nav-link nav-link-item position-relative" href="{{ url('/arsip') }}">
            <svg class="sidebar-icon" xmlns="http://www.w3.org/2000/svg" height="22" width="22"
                viewBox="0 0 640 512">
                <path fill="#ffffff"
            ...
            <span class="badge badge-pill badge-danger position-absolute mt-2 me-1"
                style="top: 0; bottom: auto; right: 0; width: 2.3rem !important; font-size: 0.6rem !important;">
                NEW
            </span>
        </a>
    </li>

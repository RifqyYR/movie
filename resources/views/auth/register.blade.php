                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <select class="form-select" name="role">
                                        <option selected value="VERIFICATOR">Verifikator</option>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="password" type="password"
                                        ...
                                        required autocomplete="new-password" onkeyup="check()">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="password-confirm" type="password" class="form-control"
                                        name="password_confirmation" required autocomplete="new-password" onkeyup="check()">

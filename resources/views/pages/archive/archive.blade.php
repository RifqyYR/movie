                    ...
                    <table class="table table-sm table-bordered-black table-hover"
                        ...
                        <tbody>
                            ...
                            @foreach ($archives as $item)
                                <tr>
                                    <td class="text-center align-middle fw-bold table-custom-fs">{{ $loop->index + 1 }}</td>
                                    <td class="align-middle fw-bold table-custom-fs">{{ $item->unit_name }}</td>
                                    <td class="align-middle fw-bold table-custom-fs">{{ $item->archive_number }}</td>
                                    <td class="align-middle fw-bold table-custom-fs">{{ $item->dos_number }}</td>
                                    <td class="align-middle fw-bold table-custom-fs">{{ $item->archive_title }}</td>
                                    <td class="align-middle fw-bold table-custom-fs">{{ $item->classification_code }}</td>
                                    <td class="align-middle fw-bold table-custom-fs">{{ $item->file_content_information }}
                                    </td>

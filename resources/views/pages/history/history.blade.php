                            ...
                            @else
                                @foreach ($claims as $item)
                                    <tr>
                                        ...
                                        <td class="fw-bold text-nowrap" style="font-size: 14px;">{{ $item->hospital_name }}
                                        </td>
                                        <td class="fw-bold text-nowrap" style="font-size: 14px;">{{ $item->claim_type }}
                                        </td>
                                        <td class="fw-bold text-nowrap" style="font-size: 14px;">{{ $item->month }}</td>
                                        <td class="text-center fw-bold text-nowrap" style="font-size: 14px;">
                                            {{ $item->file_completeness }}</td>
                                        <td class="text-center fw-bold text-nowrap" style="font-size: 14px;">
                                            {{ $item->ba_date }}</td>

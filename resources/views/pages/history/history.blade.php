...
if (!$claims->isEmpty()) {
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="text-center align-middle custom-col">
                                    Tanggal<br>
                                    <span class="text-nowrap">BA Lengkap</span></th>
                                <th scope="col" class="text-center align-middle custom-col">
                                    Tanggal<br>
                                    <span class="text-nowrap">Jatuh Tempo</span></th>
                                ...
                                @foreach ($claims as $item)
                                    <tr>
                                        ...
                                        <td
                                            class="text-center align-middle fw-bold text-nowrap table-custom-width table-custom-fs">
                                            {{ $item->ba_date }} </td>
                                        <td class="align-middle fw-bold text-nowrap table-custom-fs">{{ $item->status }}
